...
還停在 .NET 6.0 / .NET 7.0 的專案照樣能用：NuGet 會自動挑 .NET Standard 2.0 資產，
不必改任何程式碼。1.2.0 移除 net6.0 與 net7.0 這兩個目標，是因為兩者都已結束支援。
.NET Standard 2.0 資產同時涵蓋 .NET Framework 4.6.1 以後的版本。
